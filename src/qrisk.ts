import qRiskMale from "./qrisk-male";
import qRiskFemale from "./qrisk-female";

export const DISCLAIMER_TEXT = `The initial version of this file, to be found at http://svn.clinrisk.co.uk/opensource/qrisk2, faithfully implements QRISK3-2017.
